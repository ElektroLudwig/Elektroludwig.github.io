...
window.elektroLudwigLanguages.pl = {
  ...
  ui: {
    ...
    text4: "O nas",
    text5: "Zakres realizacji",
    attr6: "Pokaż podmenu",

    text7:
      '<i class="fas fa-bolt"></i> Instalacje elektryczne',

    text8:
      '<i class="fas fa-gears"></i> Przemysł i automatyka',
    ...
    text20:
      "Mówiąc prosto – wszędzie tam, gdzie potrzebna jest energia elektryczna, okablowanie, sterowanie lub technologia, potrafimy znaleźć rozwiązanie.",

    text21:
      "Nasze kompetencje",

    text22:
      "Zakres <span>realizacji</span>",

    text23:
      "Od instalacji elektrycznych w budynkach po rozległe projekty przemysłowe i automatyzacyjne. Realizujemy instalacje elektryczne, okablowanie oraz systemy technologiczne dla różnych typów obiektów, zakładów produkcyjnych i obiektów logistycznych.",

    attr24:
      "Instalacje elektryczne Elektro Ludwig",
    ...
    attr28:
      "Instalacje przemysłowe i automatyka",
    ...
    attr32:
      "Instalacje elektryczne hal produkcyjnych i przemysłowych",

    text33:
      "Hale produkcyjne i przemysłowe",

    text34:
      "Kompleksowe instalacje elektryczne, trasy kablowe, oświetlenie oraz zasilanie technologii w obiektach produkcyjnych, magazynowych i logistycznych.",
    ...
    text40:
      "01 / INSTALACJE ELEKTRYCZNE",

    text41:
      "Kompleksowe instalacje elektryczne",

    text42:
      "Wykonujemy instalacje elektryczne w nowych oraz istniejących obiektach. Prace realizujemy zgodnie z dokumentacją projektową i wymaganiami konkretnej inwestycji – od przygotowania tras kablowych aż po końcowe podłączenie poszczególnych elementów elektrycznych.",

    text43: "Instalacje silnoprądowe",
    text44: "Instalacje niskoprądowe",
    text45: "Trasy kablowe i drabinki kablowe",
    text46: "Rozdzielnice",
    text47: "Oświetlenie",
    text48: "Oświetlenie awaryjne",
    ...
    text55:
      "02 / PRZEMYSŁ I AUTOMATYKA",

    text56:
      "Technologie przemysłowe i automatyka",

    text57:
      "W projektach przemysłowych realizujemy okablowanie i elektryczne podłączenie poszczególnych technologii, urządzeń produkcyjnych oraz systemów zautomatyzowanych. Pracujemy przy projektach, w których konieczne jest połączenie zasilania, sterowania, czujników i poszczególnych elementów technologicznych w jeden funkcjonalny system.",

    text58: "Okablowanie maszyn",
    text59: "Linie zautomatyzowane",
    text60: "Czujniki",
    ...
    text70:
      "03 / HALE PRODUKCYJNE I PRZEMYSŁOWE",

    text71:
      "Instalacje elektryczne hal produkcyjnych i logistycznych",

    text72:
      "Przy rozległych projektach hal realizujemy infrastrukturę elektryczną niezbędną do funkcjonowania całego obiektu. Zakres prac może obejmować główne trasy kablowe, instalacje poszczególnych technologii, oświetlenie oraz zasilanie urządzeń produkcyjnych lub chłodniczych.",

    text73: "Główne trasy kablowe",
    text74: "Pomocnicze trasy kablowe",
    text75: "Zasilanie technologii",
    text76: "Urządzenia produkcyjne",
    text77: "Technologie logistyczne",
    text78: "Technologie chłodnicze",
    text79: "Rozdzielnice",
    text80: "Oświetlenie hal",
    text81: "Oświetlenie awaryjne",
    text82: "Kompletne instalacje elektryczne",
    ...
    text85:
      "Gdzie <span>pracowaliśmy</span>",

    text86:
      "Nasze doświadczenie zdobywaliśmy bezpośrednio przy realizacji projektów o różnej skali – od budynków i szkół po projekty produkcyjne, przemysłowe i logistyczne. Zobacz wybrane realizacje oraz zakres prac, w których uczestniczyliśmy.",

    text87:
      "Referencje w przygotowaniu",

    text88:
      "Stopniowo uzupełniamy zdjęcia oraz informacje dotyczące zrealizowanych przez nas projektów.",

    text89:
      "Skontaktuj się z nami",

    text90:
      "Jesteśmy do Państwa <span>dyspozycji</span>",
    ...
    text111:
      'Wyślij wiadomość <i class="fas fa-paper-plane"></i>',
    ...
    consentRequired:
      "Proszę potwierdzić zgodę na przetwarzanie danych osobowych.",
  ...
  projects: {
    ...
    "transgourmet-leipheim": {
      ...
      kratkyPopis:
        "Prace elektroinstalacyjne i automatyka przy realizacji nowego obiektu logistycznego i dystrybucyjnego Transgourmet w niemieckim Leipheim.",
...
Projekt Transgourmet Leipheim jest kompleksową realizacją łączącą instalacje silnoprądowe i niskoprądowe, systemy rozdzielcze oraz elementy automatyki w ramach jednego dużego obiektu logistycznego i chłodniczego.`
    },
...
Główną częścią naszych prac było podłączanie rozdzielnic oraz głównych kabli zasilających. Z tych rozdzielnic zapewniano następnie zasilanie kolejnych rozdzielnic podrzędnych oraz poszczególnych części elektrycznych obiektu.

Zakres realizacji obejmował układanie i podłączanie okablowania zgodnie z dokumentacją projektową, podłączanie poszczególnych obwodów elektrycznych oraz prace wykończeniowe przy instalacji elektrycznej.

W końcowej fazie projektu wykonywaliśmy również dodatkowe modyfikacje zgodnie z wymaganiami klienta, takie jak uzupełnianie gniazd i nowych obwodów elektrycznych, oznaczanie poszczególnych części instalacji oraz usuwanie stwierdzonych usterek lub brakujących podłączeń.

Projekt stanowi kolejną z naszych realizacji w zakresie infrastruktury energetycznej, tym razem ze szczególnym naciskiem na zasilanie silnoprądowe i systemy rozdzielcze.`
    },
    ...
    "palm-eltmann": {
      ...
      kratkyPopis:
        "Prace elektroinstalacyjne przy modernizacji technologii produkcyjnej papierni – od elektrycznego odłączenia i demontażu istniejących urządzeń po okablowanie i podłączenie nowej technologii.",

      popis:
`W papierni Palm w Eltmann uczestniczyliśmy w modernizacji części istniejącej technologii produkcyjnej, w ramach której dotychczasowe urządzenia po latach eksploatacji zostały zastąpione nowym rozwiązaniem technologicznym.

Na początku projektu wykonaliśmy elektryczne odłączenie istniejącej technologii oraz demontaż istniejącego okablowania. Poszczególne kable należało zidentyfikować zgodnie z dokumentacją projektową i określić, które z nich mogą zostać wykorzystane w nowej technologii, a które należy usunąć z tras kablowych.

Po mechanicznym montażu nowej technologii wykonaliśmy nowe okablowanie oraz elektryczne podłączenie poszczególnych urządzeń zgodnie z dokumentacją projektową. Zakres obejmował wykorzystanie wybranych istniejących przewodów, uzupełnienie nowych kabli oraz podłączenie nowych elementów technologicznych, sterujących i bezpieczeństwa.

Projekt obejmował więc cały proces z punktu widzenia instalacji elektrycznej – od wyłączenia i odłączenia istniejących urządzeń, przez modyfikację istniejących instalacji, aż po elektryczne uruchomienie nowej technologii produkcyjnej.`
    },
...
Przez około trzy do czterech miesięcy realizowaliśmy elektryczną część systemu przenośnikowego dla zakładu logistycznego Erwin Müller. Zakres obejmował okablowanie i podłączanie silników, czujników, barier świetlnych, elementów sterowania oraz innych elementów automatyki.
...
Prace odbywały się w środowisku rozległej infrastruktury energetycznej o wysokich wymaganiach dotyczących dokładności wykonania, dokumentacji oraz prawidłowego podłączenia poszczególnych systemów technologicznych i sterujących.`
    },
...
Kolejną odrębną częścią projektu była instalacja elektryczna technologii dwóch silosów magazynowych oraz centralnego systemu odciągu odpadów drzewnych. System zapewniał odciąganie trocin i innych odpadów drzewnych powstających podczas obróbki drewna oraz ich późniejszy transport do silosów magazynowych.

W ramach tej technologii realizowaliśmy okablowanie i elektryczne podłączanie dużych silników elektrycznych systemu odciągowego, czujników oraz innych elementów elektrycznych i sterujących związanych z pracą systemu odciągu i silosów magazynowych.

Projekt obejmował więc zarówno zasilanie silnoprądowe technologii produkcyjnych, jak i instalację elektryczną niezależnego systemu technologicznego centralnego odciągu w dużym zakładzie obróbki drewna.`
    },
    ...
    "schule-freising": {
      ...
      kratkyPopis:
        "Kompleksowe prace elektroinstalacyjne w nowym kompleksie szkolnym, obejmujące sale lekcyjne, przestrzenie wspólne, systemy bezpieczeństwa i oświetlenie zewnętrzne.",

      popis:
`Przy projekcie nowej szkoły Grund- und Mittelschule we Freisingu realizowaliśmy rozległe prace elektroinstalacyjne w dwóch budynkach szkolnych oraz przyległych częściach terenu szkoły.

Zakres obejmował instalacje elektryczne w poszczególnych salach lekcyjnych, pomieszczeniach biurowych i wspólnych, kuchni oraz innych częściach szkoły. Realizowaliśmy oświetlenie, instalacje gniazdowe, system sygnalizacji pożaru, oświetlenie awaryjne i ewakuacyjne, okablowanie oraz podłączanie poszczególnych elementów sterujących.

Poszczególne sale lekcyjne były wyposażone we własne rozdzielnice podrzędne, z których zasilano i sterowano urządzeniami elektrycznymi danego pomieszczenia. Zakres obejmował również elementy sterujące żaluzjami oraz innymi funkcjami poszczególnych pomieszczeń.

Prace prowadziliśmy także poza samymi budynkami. Na terenie obiektu wykonywaliśmy zewnętrzne instalacje elektryczne, prowadziliśmy okablowanie pomiędzy poszczególnymi studzienkami oraz montowaliśmy i podłączaliśmy elektrycznie duże oprawy na słupach zapewniające oświetlenie zewnętrzne terenu szkoły.

Projekt obejmował więc instalacje elektryczne praktycznie od poszczególnych sal lekcyjnych i ich rozdzielnic, poprzez systemy bezpieczeństwa, aż po oświetlenie zewnętrzne całego kompleksu szkolnego.`
    },
    ...
    "bmw-krauthausen": {
      ...
      kratkyPopis:
        "Rozległe prace elektroinstalacyjne w halach produkcyjnych, budynku administracyjnym oraz przy technologii dużych pras przemysłowych w zakładzie BMW Krauthausen.",

      popis:
`Przy projekcie BMW Krauthausen realizowaliśmy prace elektroinstalacyjne w kilku częściach nowego zakładu produkcyjnego. Zakres projektu obejmował hale produkcyjne, pomieszczenia administracyjne oraz oddzielną technologię dwóch dużych pras przemysłowych.
...
Projekt obejmował instalację elektryczną w środowisku przemysłu ciężkiego i wielkogabarytowej technologii portowej, gdzie konieczne było wykonanie elektrycznej części rozległego ruchomego systemu przenośnikowego.`
    ...
    "skoda-mlada-boleslav": {
      ...
      kratkyPopis:
        "Prace elektroinstalacyjne i podłączanie technologii linii lakierniczej w zakładzie motoryzacyjnym ŠKODA AUTO w Mladej Boleslavi.",
...
Częścią projektu była również instalacja elektryczna stanowisk kontrolnych przeznaczonych do wizualnej kontroli jakości lakieru karoserii, w tym ich specjalistycznego oświetlenia oraz elementów sygnalizacyjnych.`
    }
  ...
  additional: {
    ...
    popis:
`Oprócz wymienionych projektów uczestniczyliśmy również w innych realizacjach przemysłowych i budowlanych, przy których nie byliśmy głównym wykonawcą instalacji elektrycznej, ale w znacznym stopniu angażowaliśmy się w prace wykończeniowe, rozbudowę istniejących instalacji elektrycznych oraz usuwanie usterek technicznych.

Do takich projektów należą między innymi Jungheinrich Moosburg, GALILEO München, Porsche Leipzig i Wellpappe Alzenau.
