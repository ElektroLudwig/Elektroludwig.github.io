...
window.elektroLudwigLanguages.en = {
  ...
  ui: {
    ...
    text7:
      '<i class="fas fa-bolt"></i> Electrical installations',
    ...
    text82: "Complete electrical distribution",
  ...
  projects: {
    ...
    "transgourmet-leipheim": {
      ...
      miesto: "Leipheim, Germany",
      realizaciaPre: "TGW and Hauser",

      kratkyPopis:
        "Electrical installation and automation work for the new Transgourmet logistics and distribution facility in Leipheim, Germany.",
...
Transgourmet Leipheim is a comprehensive project combining power and low-current electrical installations, distribution systems and automation components within a single large logistics and refrigeration facility.`
    ...
    "uw-ragow": {
      nazov: "UW Ragow – 50Hertz",
      miesto: "Ragow, Germany",
...
This project is another example of our work in energy infrastructure, with a particular focus on power supplies and electrical distribution systems.`
    ...
    "palm-eltmann": {
      nazov: "Papierfabrik Palm Eltmann",
      miesto: "Eltmann, Germany",
      realizaciaPre: "Christof Industries GmbH",
...
The project therefore covered the entire electrical installation process – from shutting down and disconnecting the original equipment, through modifying existing circuits, to bringing the electrical systems of the new production equipment into operation.`
    ...
    "tgw-logistika": {
      nazov: "TGW logistics and automation systems",
      miesto: "Czech Republic / Germany",
...
At AUTODOC, we continued work on a similar type of automated logistics installation, including conveyor systems and automated storage equipment with stacker cranes.`
    ...
    "transnetbw-leingarten": {
      nazov: "TransnetBW / SuedLink – Leingarten",
      miesto: "Leingarten, Germany",
      realizaciaPre: "Christof Industries GmbH",
...
The project therefore combined power supplies for production equipment with the electrical installation of a separate central extraction system within a large timber processing plant.`
    ...
    "schule-freising": {
      nazov: "Grund- und Mittelschule Freising",
      miesto: "Freising, Germany",
      realizaciaPre: "Bachner Elektro GmbH",

      kratkyPopis:
        "Comprehensive electrical installation work at a new school campus, including classrooms, shared areas, safety systems and outdoor lighting.",
...
The project thus covered electrical installations from individual classrooms and their distribution boards through to safety systems and outdoor lighting across the entire school campus.`
    ...
    "bmw-krauthausen": {
      nazov: "BMW Krauthausen",
      miesto: "Krauthausen, Germany",
      realizaciaPre: "Bachner Elektro GmbH",
...
The two large industrial presses formed a separate part of the project. Working to the technical documentation, we installed cable containment, cabling and electrical connections for individual press components and accessories. The presses were intended to produce pressed body panels for Rolls-Royce vehicles.`
    },


    "eecv-europoort": {
      nazov: "EECV Europoort – Rotterdam",
      miesto: "Rotterdam, Netherlands",
...
The project involved electrical installation in a heavy industrial environment with high-capacity port equipment, providing the electrical systems for a large moving conveyor installation.`
    ...
    "skoda-mlada-boleslav": {
      nazov: "ŠKODA Mladá Boleslav",
      miesto: "Mladá Boleslav, Czech Republic",
      realizaciaPre: "Christof Industries GmbH",
...
The project also included electrical installations for inspection stations used to visually check the paint quality of vehicle bodies, including their specialised lighting and signalling components.`
  ...
  additional: {
    ...
    popis:
`In addition to the projects listed above, we have contributed to other industrial and construction projects where we were not the main electrical installation contractor but played a significant role in completing work, extending existing electrical installations and resolving technical defects.

These projects include Jungheinrich Moosburg, GALILEO München, Porsche Leipzig and Wellpappe Alzenau.

Depending on the project, our work included completing and extending electrical installations, lighting and emergency lighting, socket and power circuits, electrical systems for safety equipment, additional data and power cabling, diagnosing non-functioning parts of installations, and correcting identified faults and defects.

These projects also demonstrate our ability to take over an electrical installation already in progress, assess its existing condition and technical documentation, and help complete the project or resolve problems that have arisen.`
  }
