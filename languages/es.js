...
window.elektroLudwigLanguages.es = {
  ...
  ui: {
    ...
    text4: "Sobre nosotros",
    text5: "Áreas de actividad",
    attr6: "Mostrar submenú",

    text7:
      '<i class="fas fa-bolt"></i> Instalaciones eléctricas',

    text8:
      '<i class="fas fa-gears"></i> Industria y automatización',

    text9:
      '<i class="fas fa-industry"></i> Naves de producción e industriales',

    attr10:
      "Elektro Ludwig – Mucho más que electricidad",
    ...
    attr32:
      "Instalaciones eléctricas de naves de producción e industriales",
    ...
    text42:
      "Realizamos instalaciones eléctricas tanto en edificios nuevos como existentes. Los trabajos se ejecutan de acuerdo con la documentación del proyecto y los requisitos específicos de cada obra, desde la preparación de las rutas de cables hasta la conexión final de los distintos componentes eléctricos.",

    text43: "Instalaciones de potencia",
    text44: "Instalaciones de baja corriente",
    text45: "Bandejas y escaleras portacables",
    text46: "Cuadros eléctricos",
    text47: "Iluminación",
    text48: "Iluminación de emergencia",
    ...
    text70:
      "03 / NAVES DE PRODUCCIÓN E INDUSTRIALES",
    ...
    text82: "Instalaciones eléctricas completas",
    ...
    text85:
      "Dónde hemos <span>trabajado</span>",

    text86:
      "Nuestra experiencia se ha desarrollado directamente en proyectos de diferentes dimensiones, desde edificios y escuelas hasta proyectos de producción, industriales y logísticos. Descubra una selección de nuestros proyectos y el alcance de los trabajos en los que hemos participado.",

    text87:
      "Referencias en preparación",

    text88:
      "Estamos añadiendo progresivamente fotografías e información sobre los proyectos que hemos realizado.",

    text89:
      "Contacte con nosotros",

    text90:
      "Estamos a su <span>disposición</span>",
    ...
    text93:
      "N.º de identificación de la empresa",
    ...
    text109:
      "Acepto el tratamiento de los datos personales proporcionados con el fin de gestionar mi consulta. *",
    ...
    consentRequired:
      "Por favor, confirme su consentimiento para el tratamiento de datos personales.",
  ...
  projects: {
    ...
    "transgourmet-leipheim": {
      ...
      kratkyPopis:
        "Trabajos de instalación eléctrica y automatización durante la construcción del nuevo centro logístico y de distribución de Transgourmet en Leipheim, Alemania.",
...
El proyecto Transgourmet Leipheim es una realización compleja que combina instalaciones de potencia y baja corriente, sistemas de distribución eléctrica y elementos de automatización dentro de un gran complejo logístico y frigorífico.`
    ...
    "uw-ragow": {
      ...
      kratkyPopis:
        "Trabajos de instalación eléctrica en las instalaciones de la subestación eléctrica 50Hertz, incluido el conexionado de cuadros eléctricos, cables principales de alimentación y las instalaciones eléctricas asociadas.",

      popis:
`En el proyecto UW Ragow de 50Hertz realizamos trabajos de instalación eléctrica en las instalaciones técnicas de la subestación eléctrica.

La parte principal de nuestros trabajos consistió en conectar los cuadros eléctricos y los principales cables de alimentación. Desde estos cuadros se distribuía posteriormente la alimentación hacia otros cuadros secundarios y las distintas partes eléctricas de la instalación.

La realización incluía el tendido y conexionado del cableado de acuerdo con la documentación del proyecto, la conexión de los distintos circuitos eléctricos y trabajos finales en la instalación eléctrica.

En la fase final del proyecto también realizamos modificaciones adicionales según los requisitos del cliente, como la instalación de tomas y nuevos circuitos eléctricos, el etiquetado de las distintas partes de la instalación y la corrección de defectos detectados o conexiones pendientes.

Este proyecto constituye otra de nuestras realizaciones en el ámbito de las infraestructuras energéticas, en este caso centrada especialmente en la alimentación eléctrica de potencia y los sistemas de distribución.`
    },
...
Por tanto, el proyecto abarcó todo el proceso desde el punto de vista de la instalación eléctrica: desde la puesta fuera de servicio y desconexión de los equipos existentes, pasando por la modificación de las instalaciones existentes, hasta la puesta en servicio eléctrica de la nueva tecnología de producción.`
    ...
    "tgw-logistika": {
      ...
      nazov:
        "Sistemas logísticos y de automatización TGW",
...
El proyecto incluía, por tanto, tanto la alimentación eléctrica de potencia de las tecnologías de producción como la instalación eléctrica de un sistema tecnológico independiente de aspiración centralizada en una gran planta de procesamiento de madera.`
    ...
    "schule-freising": {
      ...
      kratkyPopis:
        "Amplios trabajos de instalación eléctrica en un nuevo complejo escolar, incluidas aulas, zonas comunes, sistemas de seguridad e iluminación exterior.",
...
El proyecto también incluía la instalación eléctrica de los puestos de inspección destinados al control visual de la calidad de la pintura de las carrocerías, incluida su iluminación especializada y los elementos de señalización.`
  ...
  additional: {
    ...
    popis:
`Además de los proyectos mencionados, también hemos participado en otras realizaciones industriales y de construcción en las que no éramos el contratista principal de la instalación eléctrica, pero contribuimos de forma significativa a los trabajos finales, la ampliación de instalaciones eléctricas existentes y la resolución de problemas técnicos.
